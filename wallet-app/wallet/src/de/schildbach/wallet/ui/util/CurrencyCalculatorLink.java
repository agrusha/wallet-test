...
public final class CurrencyCalculatorLink {
    ...
    public CurrencyCalculatorLink(@Nonnull final CurrencyAmountView btcAmountView, @Nonnull final CurrencyAmountView localAmountView) {
        ...
        this.btcAmountView.setListener(new BtcAmountViewListener());

        this.localAmountView = localAmountView;
        this.localAmountView.setListener(new LocalAmountViewListener());
    ...
    private class LocalAmountViewListener implements CurrencyAmountView.Listener {
        @Override
        public void changed() {
    ...
    private class BtcAmountViewListener implements CurrencyAmountView.Listener {
        @Override
        public void changed() {
