...
public class WalletApplication extends Application {
    ...
    public void startBlockchainService(final boolean cancelCoinsReceived) {
        blockchainServiceController.startBlockchainService(cancelCoinsReceived);
    }

    public void stopBlockchainService() {
        blockchainServiceController.stopBlockchainService();
    }
    ...
    public void replaceWallet(final Wallet newWallet) {
        blockchainServiceController.resetBlockchainService(); // implicitly stops blockchain service
