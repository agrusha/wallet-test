...
public class TransactionController implements Observable<TransactionController> {
    ...
    public ListenableFuture<List<Transaction>> loadTransactions(final TransactionManager.Direction direction) {
    ...
    private List<Transaction> applyTransactionsFilter(List<Transaction> origin, TransactionManager.Direction direction) {
    ...
    private class TransactionsFilter implements Predicate<Transaction> {
        private final TransactionManager.Direction direction;
        @Override
        public boolean apply(Transaction input) {
            ...
            return direction == null || !isInternal && ((direction == TransactionManager.Direction.SENT) == sent);
        }
    }
